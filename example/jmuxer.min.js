  ...
  var JMuxer = /*#__PURE__*/function (_Event) {
    ...
    _createClass(JMuxer, [{
      ...
      value: function setupMSE() {
        var MediaSource = window.ManagedMediaSource || window.MediaSource || window.WebKitMediaSource;
      ...
      value: function isSupported(codec) {
        var _window$MediaSource, _window$ManagedMediaS;

        return (window.MediaSource || window.ManagedMediaSource) && (((_window$MediaSource = window.MediaSource) === null || _window$MediaSource === void 0 ? void 0 : _window$MediaSource.isTypeSupported(codec)) || ((_window$ManagedMediaS = window.ManagedMediaSource) === null || _window$ManagedMediaS === void 0 ? void 0 : _window$ManagedMediaS.isTypeSupported(codec)));
      }
    }]);
